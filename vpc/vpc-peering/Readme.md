# Created 2 vpcs, subnet, rts in the console. Trying to familiarize myself with everything including the console.
...
```sh
aws ec2 delete-vpc-peering-connection --vpc-peering-connection-id pcx-0fe2338850ecfe82a
```
# Deleted 2 vpcs, subnet, rts in the console. Trying to familiarize myself with everything including the console.
